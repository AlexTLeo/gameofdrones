...
int main (int argc, char *argv[]) {
  ...
  //fdSocket[1] = socketCreate(AF_INET, SOCK_STREAM, 0, fdlogErr);
  //fdSocket[2] = socketCreate(AF_INET, SOCK_STREAM, 0, fdlogErr);
  //fdSocket[3] = socketCreate(AF_INET, SOCK_STREAM, 0, fdlogErr);
  //fdSocket[4] = socketCreate(AF_INET, SOCK_STREAM, 0, fdlogErr);
