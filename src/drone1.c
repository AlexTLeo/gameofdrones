...
int main(int argc, char *argv[]){
    ...
    current_pos[0] = START1[0];
    current_pos[1] = START1[1];
    ...
    printf("Drone 1 started\n");
    while (1) {

        // random direction between 0 and 7
        int inc = (int)rand()%8;
        ...
        while (current_step<max_steps){
            ...
            if (response == MASTER_OK){
                ...
                writeErrorLog(fd_logError, "[drone 1] unkown response message from master",2);
            }
